...
def make_model(tgt_vocab, N=4, d_model=256, d_ff=1024, d_feature=1024, h=8, dropout=0.1):
...
# model = make_model(50)
# print(model)
# image_batch = torch.rand(3,152,32)
# target = torch.rand(64,30)
# output = model(input,target,input,target)
# print(output)
